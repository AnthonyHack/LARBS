...
# Updating this to work with Fedora core, 33 will be the test bed. 11/1/2020
# by Anthony Hack
# License: GNU GPLv3

## 11/1/2020
### I'm leaving in the orignal code as examples of what I changed for now, I will more then likely clean them up once this is confirmed working.
...
## 11/1/2020
### We dont need aur helper with fedora, 
#while getopts ":a:r:b:p:h" o; do case "${o}" in
...
## 11/1/2020
### Again dont need aurhelper for fedora
#[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/lukesmithxyz/voidrice.git"
#[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/LukeSmithxyz/LARBS/master/progs.csv"
